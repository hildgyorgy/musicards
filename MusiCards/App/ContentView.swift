        ...
        -> some View
    {
        ...
        case .artist:
            ArtistCardContentView(
                    ...
                    wikipediaError: appModel.artistWikipediaError,
                    isWikipediaUnavailable: appModel.isArtistWikipediaUnavailable,
                    onRetryWikipedia: { appModel.retryArtistWikipedia() },
                    isLoadingDiscography: appModel.isLoadingArtistDiscography,
